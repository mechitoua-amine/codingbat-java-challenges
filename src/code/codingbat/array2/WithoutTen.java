...
public class WithoutTen {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(withoutTen(1, 10, 10, 2)));
        System.out.println(Arrays.toString(withoutTen(10, 2, 10)));
        System.out.println(Arrays.toString(withoutTen(1, 99, 10)));
    }

    public static int[] withoutTen(int... nums) {
        int[] arrCpy = new int[nums.length];
        int zeroPos = 0;
        for (int num : nums) {
            if (num != 10) {
                arrCpy[zeroPos] = num;
