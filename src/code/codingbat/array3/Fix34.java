...
public class Fix34 {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(fix34(1, 3, 1, 4)));
        System.out.println(Arrays.toString(fix34(1, 3, 1, 4, 4, 3, 1)));
        System.out.println(Arrays.toString(fix34(3, 2, 2, 4)));
    }
