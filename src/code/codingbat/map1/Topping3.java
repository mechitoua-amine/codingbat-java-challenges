 ...
 * the map as follows: if the key "potato" has a value, set that
 * as the value for the key "fries". If the key "salad" has a value,
...
public class Topping3 {
    public static void main(String[] args) {
        System.out.println(topping3(new HashMap<>() {
            {
                put("potato", "ketchup");
            }
        }));
